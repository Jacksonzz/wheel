...
/**
 * @program: BusinessThreeStageWorkServiceImpl
 * @description:
 * @author: zhou zhi
...
@Slf4j
@Service
public class BusinessThreeStageWorkServiceImpl implements StageWorkService {
    @Autowired
    DealDifferentStageService dealDifferentStageService;

    @PostConstruct
    public void init() {
        dealDifferentStageService.registerStageWorkService(2, this);
    }
